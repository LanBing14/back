...
>
                ...
                <el-table-column label="权限">
                    <template slot-scope="scope">
                        <el-checkbox
                            v-if="scope.row.attributes.permissions"
                            :indeterminate="isIndeterminates['isIndeterminate'+scope.row.id]"
                            v-model="checkAlls['checkAll'+scope.row.id]"
                            @change="handleCheckAllChange(scope.row.id)"
>
                            全选
                        </el-checkbox>
                        <a-checkbox-group
                            v-model="grantForm['permissions'+scope.row.id]"
                            @change="handleCheckedCitiesChange(scope.row.id)"
                        >
                            <el-checkbox
                                v-for="item in scope.row.attributes.permissions"
                                :key="item.value"
                                :label="item.value"
                                :checked="item.checked"
                                name="permissions"
